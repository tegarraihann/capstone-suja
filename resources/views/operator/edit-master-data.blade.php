...
{
$month = date('n');
if ($month >= 1 && $month <= 3) { return '1' ; } elseif ($month>= 4 && $month <= 6) { return '2' ; } elseif ($month>= 7
        && $month <= 9) { return '3' ; } else { return '4' ; } } $triwulan=getQuarter(); @endphp @if
            (!empty(session('success'))) <script>
            swal({
                    ...
                    <form class="mx-auto" action="{{ url('operator/edit-master-data/' . $dataIku->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="flex gap-x-10 gap-y-3 w-full items-center justify-between">
                                ...
                                <div class="mb-5 w-1/2">
                                    ...
                                    <input type="number" min="0" max="100" name="perjanjian_kinerja_realisasi_kumulatif"
                        ...
                        <div class="mt-4">
                            <div class="mb-5 w-full">
                                <label for="link_bukti_dukung_capaian"
                            ...
                            <div class="mb-5 w-full">
                                <label for="upaya_yang_dilakukan"
                                    class="block mb-2 text-sm font-medium text-gray-900">Upaya yang
                                    dilakukan</label>
                                <textarea type="text" name="upaya_yang_dilakukan" id="upaya_yang_dilakukan"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    placeholder="Masukkan upaya yang sudah dilakukan" rows="6"
                                    required>{{ old('upaya_yang_dilakukan', $dataIku->upaya_yang_dilakukan) }}</textarea>
                            </div>
                            <div class="mb-5 w-full">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-x-10 gap-y-3 w-full items-center justify-between">
                                <div class="mb-5 w-full">
                                    <label for="kendala"
                                        class="block mb-2 text-sm font-medium text-gray-900">Kendala</label>
                                    <textarea type="text" name="kendala" id="kendala"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        placeholder="Masukkan kendala saat triwulan ini" rows="6"
                                        required>{{ old('kendala', $dataIku->kendala) }}</textarea>
                                </div>
                                <div class="mb-5 w-full">
                                    ...
                                    <textarea type="text" name="solusi_atas_kendala" id="solusi_atas_kendala"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        placeholder="Masukkan solusi atas kendala" rows="6"
                                        required>{{ old('solusi_atas_kendala', $dataIku->solusi_atas_kendala) }}</textarea>
                                </div>
                            </div>
                            <div class="mb-5 w-full">
                                <label for="rencana_tidak_lanjut"
                                    class="block mb-2 text-sm font-medium text-gray-900">Rencana
                                    tindak lanjut</label>
                                <textarea type="text" name="rencana_tidak_lanjut" id="rencana_tidak_lanjut"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    placeholder="Masukkan rencana tindak lanjut untuk triwulan berikutnya" rows="6"
                                    required>{{ old('rencana_tidak_lanjut', $dataIku->rencana_tidak_lanjut) }}</textarea>
                            </div>
                            <div class="mb-5 w-full">
                            ...
                            <div class="mb-5 w-1/4">
                                <label for="tenggat_tidak_lanjut"
                                    class="block mb-2 text-sm font-medium text-gray-900">Batas waktu
                                    tindak lanjut</label>
                                <input type="date" name="tenggat_tidak_lanjut" id="tenggat_tidak_lanjut"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    required
                                    value="{{ old('tenggat_tidak_lanjut', $dataIku->tenggat_tidak_lanjut) }}" />
                            </div>
                        </div>
