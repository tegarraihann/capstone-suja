...
<div class="w-full p-5 h-full">
    <a class="text-gray-600 font-semibold text-2xl flex items-center gap-3" href="{{ url('operator/dashboard') }}"><i
            class="fa-solid fa-angle-left text-lg"></i> Edit Master Data</a>
        ...
        <form class="mx-auto" method="post">
            ...
            <div class="">
                ...
                <div class="flex gap-x-10 gap-y-3 w-full items-center justify-between">
                    ...
                    <div class="mb-5 w-1/2">
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">Terhadap target setahun</label>
                        <input type="text" name="name" id="nama"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Masukkan realisasi komulatif" />
                    </div>
            ...
            <div class="">
                ...
                <div class="grid grid-cols-2 gap-x-10 gap-y-3 w-full items-center justify-between">
                    ...
                    <div class="mb-5 w-full">
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">Rencana tindak lanjut</label>
                        <textarea type="text" name="name" id="nama"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Masukkan realisasi komulatif" rows="6"></textarea>
                    </div>
                    <div class="mb-5 w-full">
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">PIC tindak lanjut</label>
                        <textarea type="text" name="name" id="nama"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Masukkan realisasi komulatif" rows="6"></textarea>
                    </div>
                    <div class="mb-5 w-full">
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">Batas waktu tindak lanjut</label>
